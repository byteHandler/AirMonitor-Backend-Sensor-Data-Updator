...
def on_message(client, userdata, msg):                      # Func for receiving msgs
    ...
    f = open("disp.confg","w+")
    if str(msg.payload)[0] == 't' or str(msg.payload)[0] == 'f':
...
awshost = "a2adq3e0j8pbg4-ats.iot.us-west-2.amazonaws.com"    # Endpoint
awsport = 8883                                              # Port no.   
clientId = "aws_thing1"                                     # Thing_Name
thingName = "aqi_thing"                                    # Thing_Name
caPath = "rootCA.pem"                                      # Root_CA_Certificate_Name
